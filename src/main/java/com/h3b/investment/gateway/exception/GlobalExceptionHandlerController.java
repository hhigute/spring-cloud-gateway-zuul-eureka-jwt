package com.h3b.investment.gateway.exception;
...
public class GlobalExceptionHandlerController {
    ...
    public void handleIllegalArgumentException(HttpServletResponse res, IllegalArgumentException e) throws IOException {
        LOG.error("ERROR", e);
        res.sendError(HttpStatus.BAD_REQUEST.value(), "GlobalExceptionHandler -IllegalArgumentException");
    }

    @ExceptionHandler(Exception.class)
    public void handleException(HttpServletResponse res, Exception e) throws IOException {
        LOG.error("ERROR", e);
        res.sendError(HttpStatus.BAD_REQUEST.value(), "GlobalExceptionHandler - Exception");
    }
