package com.h3b.investment.gateway.controller;
...
import com.h3b.investment.gateway.bean.auth.AuthResponse;
import com.h3b.investment.gateway.bean.auth.LoginRequest;
...
public class LoginController {
    ...
    public ResponseEntity<User> createUser(@RequestBody User request){
    	User userResponse = iLoginService.saveUser(request);
